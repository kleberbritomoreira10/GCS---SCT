...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/x86_64-linux-gnu/ruby/2.3.0/x86_64-linux")
  ...
  CONFIG["configure_args"] = " '--build=x86_64-linux-gnu' '--prefix=/usr' '--includedir=$${prefix}/include' '--mandir=$${prefix}/share/man' '--infodir=$${prefix}/share/info' '--sysconfdir=/etc' '--localstatedir=/var' '--libdir=$${prefix}/lib/x86_64-linux-gnu' '--libexecdir=$${prefix}/lib/x86_64-linux-gnu' '--disable-maintainer-mode' '--disable-dependency-tracking' 'build_alias=x86_64-linux-gnu' 'CFLAGS=-g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security' 'LDFLAGS=-Wl,-Bsymbolic-functions -Wl,-z,relro' 'CPPFLAGS=-D_FORTIFY_SOURCE=2' 'CXXFLAGS=-g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security'"
  ...
  CONFIG["LDFLAGS"] = "-L. -Wl,-Bsymbolic-functions -Wl,-z,relro -fstack-protector -rdynamic -Wl,-export-dynamic"
  CONFIG["CFLAGS"] = "-g -O2 -fstack-protector --param=ssp-buffer-size=4 -Wformat -Werror=format-security"
  CONFIG["CXX"] = "g++"
  CONFIG["CC"] = "gcc"
  ...
  CONFIG["libdir"] = "$(prefix)/lib/x86_64-linux-gnu"
  CONFIG["psdir"] = "$(docdir)"
  ...
  CONFIG["libexecdir"] = "$(prefix)/lib/x86_64-linux-gnu"
